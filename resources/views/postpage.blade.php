            ...
            @else
                @foreach(\App\Models\Warehouse::all() as $postdata)
                    <div class="col-lg-4 col-md-6">
                        <!-- feature -->
                        <div class="feature-item">
                            <div class="feature-pic set-bg" data-setbg="{{asset('sourceimg/post')}}/{{$postdata->img_numb}}">
                            </div>
                            <div class="feature-text">
                                <div class="text-center feature-title">
                                    <p><i class="fa fa-map-marker"></i> {{$postdata->address}}</p>
                                ...
                                <div class="room-info-warp">
                                    <div class="room-info">
                                        <div class="rf-left">
                                            <p><i class="fa fa-industry"></i> {{$postdata->name}}</p>
                                            <p><i class="fa fa-location-arrow"></i> {{$postdata->city}}</p>
                                            <p><i class="fa fa-compass"></i>{{$postdata->address}} </p>
                                            <p><i class="fa fa-compass"></i>{{$postdata->description}} </p>
                                        </div>
                                    </div>
                                    <div class="room-info">
                                        <div class="rf-left">
                                            <p><i class="fa fa-beer"></i> {{$postdata->size}}</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
