...
<section id="sidebar">
  ...
  <div id="sidebar-nav" style="background-color: black;">
    ...
    <div class="profileimg">
      <a href="#" ><img  title="Profile Image" style="    width: 120px; height:100px; margin-bottom: 20px; margin-left:22px;" src="sourceimg/profile/man.jpg" alt=""></a>
      ...
      <ul>
          ...
          <li class="active"><a href="{{route('tenet_profile')}}"><i class="fa fa-user"></i> Профиль</a></li>
