...
<body>
    <!-- multistep form -->
<form id="msform" action="{{route('registerfortenet')}}" method="post">
	@csrf
	@if ($errors->any())
  ...
  <!-- fieldsets -->
  <fieldset>
    <h2 class="fs-title">Create Tenant account</h2>
    ...
    <input type="button" name="next" class="next action-button" value="Next"  require/>
  </fieldset>
